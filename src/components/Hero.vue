...
.overlay {
  ...
  background:
    linear-gradient(180deg, rgba(11,9,8,0.35) 0%, rgba(11,9,8,0.55) 55%, rgba(11,9,8,0.96) 100%),
    linear-gradient(90deg, rgba(11,9,8,0.75) 0%, rgba(11,9,8,0.15) 55%);
}
...
.reveal-tag {
  opacity: 0; animation: reveal-in 0.7s 0.1s cubic-bezier(0.22,1,0.36,1) forwards;
}
.title {
  ...
  margin-bottom: 16px;
  opacity: 0; animation: reveal-in 0.8s 0.22s cubic-bezier(0.22,1,0.36,1) forwards;
}
.subtitle {
  ...
  max-width: 460px;
  margin-bottom: 30px;
  opacity: 0; animation: reveal-in 0.8s 0.36s cubic-bezier(0.22,1,0.36,1) forwards;
}
.cta-row {
  display: flex; gap: 14px; flex-wrap: wrap;
  opacity: 0; animation: reveal-in 0.8s 0.5s cubic-bezier(0.22,1,0.36,1) forwards;
}
@keyframes reveal-in {
...
.scroll-hint {
  ...
  z-index: 2; width: 22px; height: 36px; border: 1.5px solid rgba(245,239,230,0.4);
...
@keyframes sc { 0% { opacity: 1; transform: translateY(0); } 100% { opacity: 0; transform: translateY(10px); } }

@media (prefers-reduced-motion: reduce) {
  .bg-image { animation: none; }
  .particles { display: none; }
  .reveal-tag, .title, .subtitle, .cta-row { opacity: 1; animation: none; transform: none; }
}

@media (max-width: 600px) {
  .hero { align-items: center; padding-bottom: 40px; text-align: left; }
  .cta-row .btn { flex: 1; }
}
</style>
