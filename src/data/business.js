...
export const business = {
  ...
  subtitle: 'Nikmati seblak dan masakan rumahan favoritmu dengan pilihan topping sesuai selera.',
  address: import.meta.env.VITE_BUSINESS_ADDRESS || 'Jl. Contoh No. 123, Bogor, Jawa Barat',
